...
//    UIView *hederView = [[UIView alloc] initWithFrame:CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width, 64)];
...
//    [self.view addSubview:true];
    ...
    //self.view.backgroundColor = [UIColor colorWithRed:(247/255.0) green:(250/255.0) blue:(255/255.0) alpha:1.0];
...
- (UIButton *)sendButtonItem {
    ...
    NSString *sendTitle = NSLocalizedString(@"", nil);
    
    UIButton *sendButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 40, 35)];
  ...
  //  [sendButton setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
   // [sendButton setTitleColor:[[UIColor blueColor] colorByDarkeningColorWithValue:0.1f] forState:UIControlStateHighlighted];
    UIImage *img = [UIImage imageNamed:@"send_icon"];
    [sendButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateDisabled];
    [sendButton setImage:img forState:UIControlStateNormal];
